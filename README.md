...
Здесь я собрал наиболее популярные вопросы от HR-рекрутеров, на которые я отвечал последнюю неделю и, возможно, которые ты, уважаемый рекрутер, прочитав возьмешь для себя необходимое.

К вопросу автоматизации, когда ручной процесс встречается дважды, и тем более если больше, то его нужно автоматизировать, что я и сделал с помощью этой сраницы.
...
## 8. По стеку: (хотели бы в нем остаться или готовы к переходу на другие языки, например) и расскажите, пожалуйста?

я начал и хотел бы продолжить развиваться в направлении оркестрации с помощью Кубернетес и создания инфраструктуры IaC. Также мне интересно CI/CD и всякого рода автоматизация, чтоб потом ничего не делать, а оно само все:)
